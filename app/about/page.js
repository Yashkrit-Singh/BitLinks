export default function About() {
  return (
    <div className="max-w-4xl mx-auto p-8 mt-12 bg-purple-50 rounded-lg shadow-md">
      ...
      <p className="text-gray-700 text-lg">
        Our mission is to provide the most straightforward and private URL
        shortening service on the web.
      </p>
    </div>
  );
}
